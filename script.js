...
// Dirubah 
const pengirim = "Farhan";
const usernametele = "@Santayiiii" // awalan nomor 0 harus di awalin 62
const texttele = "Ah bisa aja kamu"
...
hilang2.addEventListener('click', () => {
  window.open(`https://telegram.org/${usernametele}/?text=${texttele}`, '_blank')
})
